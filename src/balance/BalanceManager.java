...
public class BalanceManager {
	 ...
	 * @returns true if balance equal to balance was last received at address rxAddress, else false
	 * */
	 ...
	 * @param rxAddress
	 * 				the address to check
	 * @returns true if balance greater than balance was last received at address rxAddress, else false
	 * */
	 ...
	 * @param rxAddress
	 * 				the address to check
	 * @returns true if balance greater than or equal to balance was last received at address rxAddress, else false
	 * */
	 ...
	 * @param rxAddress
	 * 				the address to check
	 * @returns true if balance lesser than balance was last received at address rxAddress, else false
	 * */
	 ...
	 * @param rxAddress
	 * 				the address to check
	 * @returns true if balance lesser than or equal to balance was last received at address rxAddress, else false
	 * */
	 ...
	 * @param rxAddress
	 * 				the address to check
	 * @returns balance of last asset transaction received at address (up to 10), null if none
	 * */
	public Balance lastReceived(String address) throws MultichainException {
		...
		return new Balance(tw.getBalance().getAssets().get(0).getName(), new BigDecimal(tw.getBalance().getAssets().get(0).getQty()));
	}
